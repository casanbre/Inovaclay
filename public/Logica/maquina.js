const opcionesPorMaquina = {
    ...
    "Corte": ["PRECORTE", "TORNILLO", "CORREAS", "RODILLOS", "FINAL DE CARRERA", "RODAMIENTO", "CHUMACERA", "POLEAS", "MOTOR", "REDUCTO", "ESTRUCTURA", "CABLEADO", "FLUIDO ELECTRICO"],
  ...
  document.getElementById("signatureForm").addEventListener("submit", function (event) {
    ...
    const data = {
      ...
      maquinas: document.getElementById("area").value === "OPERATIVA" ? "" : document.getElementById("maquina").value,
